import importlib
cre_stereo = importlib.import_module("thirdparty.CREStereo.nets.crestereo")
...
class CREStereoBLock:
    ...
    def load(self, model_path):
        ...
        pretrained_dict = mge.load(model_path, map_location=self.device)
        self.model.load_state_dict(pretrained_dict["state_dict"], strict=True)
    ...
    def _conv_image(self,img):
        ...
        img = mge.tensor(img).astype("float32")

        img_dw2 = F.nn.interpolate(
                img,
